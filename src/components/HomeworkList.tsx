...
function HomeworkCard({ hw }: { hw: Homework }) {
  ...
  return (
    <div
      className={`group relative flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/5 hover:ring-blue-100 ${isOverdue ? "opacity-60 bg-slate-50/50" : ""}`}
    >
...
export default function HomeworkList({ homeworks }: { homeworks: Homework[] }) {
